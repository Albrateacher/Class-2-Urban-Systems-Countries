...
lyr_CartoDark_0.setVisible(true);lyr_worldadministrativeboundaries1_1.setVisible(true);lyr_World_Cities_2.setVisible(true);
var layersList = [lyr_CartoDark_0,lyr_worldadministrativeboundaries1_1,lyr_World_Cities_2];
